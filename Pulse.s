...
;---------------------------------------------------
LOW					EQU	0x00000028   ; 40 us for low 
HIGH				EQU	0x0000000A   ; 10 us for high
;---------------------------------------------------
...
My_Timer0A_Handler	PROC
					...
					LDR R2,[R1]				; LOAD THE RELOAD VALUE
					CMP R2, #LOW
					BEQ LOV
					; IF THE RELOAD VALUE IS HIGH
					LDR R2, =LOW
					STR R2, [R1]
					LDR R1, =GPIO_PORTF_DATA ; disable analog
					MOV R2,#0x0
					STR R2,[R1]
					B 	OUT
					
					; IF THE RELOAD VALUE IS LOW
LOV					LDR R2, =HIGH
					STR R2, [R1]
					LDR R1, =GPIO_PORTF_DATA ; disable analog
					MOV R2,#0x04
