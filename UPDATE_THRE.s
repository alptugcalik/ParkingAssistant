...
UPDATE_THRE	PROC
		...
		; UPDATE THE VALUE ACCORDING TO THE CURRENT THRESHOLD
		LDR R5,=0x20000560
		LDR R4,[R5]
		; R4 CONTAINS THE THRESHOLD VALUE
		MOV R0,#10
		MOV R3,R4
		UDIV R2,R3,R0
		MUL R5,R2,R0
